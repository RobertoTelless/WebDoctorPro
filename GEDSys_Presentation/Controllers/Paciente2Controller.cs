...
namespace GEDSys_Presentation.Controllers
{
    public class Paciente2Controller : Controller
    {
        ...
        public ActionResult GerarRelatorioDetalhe()
        {
            try
            {
                ...
                if (paciente.PACI_NM_ENDERECO != null)
                {
                    ...
                    {
                        cell = new PdfPCell(new Paragraph("UF: - ", meuFont1));
                        cell.Border = 0;
                        cell.Colspan = 1;
                        cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                        cell.HorizontalAlignment = Element.ALIGN_LEFT;
                ...
                {
                    cell = new PdfPCell(new Paragraph("Raça: " + paciente.COR.COR1_NM_NOME, meuFont1));
                    cell.Border = 0;
                    cell.Colspan = 1;
                    cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                    cell.HorizontalAlignment = Element.ALIGN_LEFT;
                ...
                {
                    cell = new PdfPCell(new Paragraph("Raça: -", meuFont1));
                    cell.Border = 0;
                    cell.Colspan = 1;
                    cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                    cell.HorizontalAlignment = Element.ALIGN_LEFT;
        ...
        public ActionResult EditarAnotacaoAnamnese(PacienteAnamneseAnotacaoViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    return RedirectToAction("VerAnotacaoAnamnese", "Paciente2");
                }
                catch (Exception ex)
                {
                    ViewBag.Message = ex.Message;
        ...
        public async Task<ActionResult> EnviarEMailConfirmacao(Int32 id)
        {
            // Recupera informações
            Int32 idAss = (Int32)Session["IdAssinante"];
            USUARIO usuario = (USUARIO)Session["UserCredentials"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> IncluirConsultaGeral(PacienteConsultaViewModel vm)
        {
            if ((String)Session["Ativa"] == null)
            {
                return RedirectToAction("Logout", "ControleAcesso");
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    LOG log = new LOG
                    {
                        ...
                        ASSI_CD_ID = usuario.ASSI_CD_ID,
                        USUA_CD_ID = usuario.USUA_CD_ID,
                        LOG_NM_OPERACAO = "Paciente - Consulta - Marcação",
                        LOG_IN_ATIVO = 1,
                        LOG_TX_REGISTRO = json,
                        LOG_IN_SISTEMA = 6
                    };
                    ...
                    hist.PAHI_NM_OPERACAO = "Paciente - Marcação de Consulta";
                    hist.PAHI_DS_DESCRICAO = "Paciente " + pac.PACI_NM_NOME + " - Consulta marcada " + item.PACO_DT_CONSULTA.ToShortDateString();
        ...
        public ActionResult ExcluirConsulta(Int32 id)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    ASSI_CD_ID = usuarioLogado.ASSI_CD_ID,
                    USUA_CD_ID = usuarioLogado.USUA_CD_ID,
                    LOG_NM_OPERACAO = "Paciente - Consulta - Exclusão",
                    LOG_IN_ATIVO = 1,
                    LOG_TX_REGISTRO = json,
                    LOG_IN_SISTEMA = 6
                };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditarConsultaCompleta(PacienteConsultaViewModel vm)
        {
            if ((String)Session["Ativa"] == null)
            {
                return RedirectToAction("Logout", "ControleAcesso");
        ...
        public ActionResult GerarListagemAusencia()
        {
            try
            {
                ...
                {
                    PdfPCell cell2 = new PdfPCell(new Paragraph("Pacientes - Ausentes por mais de " + conf.CONF_IN_PACIENTE_AUSENCIA.ToString() + " meses após data prevista de retorno", meuFont2))
                    {
                        VerticalAlignment = Element.ALIGN_MIDDLE,
                        HorizontalAlignment = Element.ALIGN_CENTER
                    };
        ...
        public ActionResult GerarRelatorioHistorico()
        {
            try
            {
                ...
                if (conf.CONF_IN_LOGO_EMPRESA == 1)
                {
                    ...
                    cell1 = new PdfPCell(new Paragraph("Histórico dos Pacientes", meuFont2))
                    {
                        VerticalAlignment = Element.ALIGN_MIDDLE,
                        HorizontalAlignment = Element.ALIGN_CENTER
                    };
                ...
                {
                    PdfPCell cell2 = new PdfPCell(new Paragraph("Histórico dos Pacientes", meuFont2))
                    {
                        VerticalAlignment = Element.ALIGN_MIDDLE,
                        HorizontalAlignment = Element.ALIGN_CENTER
                    };
        ...
        public async Task<ActionResult> IncluirConsultaRecursiva()
        {
            // Inicialização
        ...
        public PACIENTE_ANAMNESE RemontarAnamnese(PACIENTE_ANAMNESE l)
        {
            using (var context = new CRMSysDBEntities())
            {
                var mediDTO = new PACIENTE_ANAMNESE()
                {
                    ASSI_CD_ID = l.ASSI_CD_ID,
                    PACO_CD_ID = l.PACO_CD_ID,
                    PACI_CD_ID = l.PACI_CD_ID,
        ...
        public DTO_Paciente_Resposta MontarPacienteRespostaDTOObj(RESPOSTA_CONSULTA l)
        {
            using (var context = new CRMSysDBEntities())
            {
                var mediDTO = new DTO_Paciente_Resposta()
                {
                    ASSI_CD_ID = l.ASSI_CD_ID,
                    PACI_CD_ID = l.PACI_CD_ID,
                    RECO_EM_EMAIL = l.RECO_EM_EMAIL,
                    RECO_DT_DATA = l.RECO_DT_DATA,
                    RECO_IN_ATIVO = l.RECO_IN_ATIVO,
                    RECO_NR_CELULAR = l.RECO_NR_CELULAR,
                    RECO_CD_ID = l.RECO_CD_ID,
                    USUA_CD_ID = l.USUA_CD_ID,
                    RECO_IN_VISTO = l.RECO_IN_VISTO,
        ...
        [HttpGet]
        public ActionResult ExcluirPrevia(Int32 id)
        {
            try
            {
                // Verifica se tem usuario logado
                ...
                if ((USUARIO)Session["UserCredentials"] != null)
                {
                    ...
                    {
                        Session["MensPermissao"] = 2;
                        Session["ModuloPermissao"] = "Paciente - Resposta - Exclusão";
                        return RedirectToAction("VoltarAnexoPaciente");
                    }
                }
                else
                ...
                RESPOSTA_CONSULTA item = baseApp.GetRespostaById(id);
                ...
                LOG log = new LOG
                {
                    ...
                    ASSI_CD_ID = usuarioLogado.ASSI_CD_ID,
                    USUA_CD_ID = usuarioLogado.USUA_CD_ID,
                    LOG_NM_OPERACAO = "Paciente - Resposta - Exclusão",
                    LOG_IN_ATIVO = 1,
                    LOG_TX_REGISTRO = json,
                    LOG_IN_SISTEMA = 6
                };
                ...
                hist.PAHI_NM_OPERACAO = "Paciente - Exclusão de Resposta";
                hist.PAHI_DS_DESCRICAO = "Paciente " + objetoAntes.PACI_NM_NOME + " Resposta excluída " + item.RECO_TX_MOTIVO;
                Int32 voltaHist = baseApp.ValidateCreateHistorico(hist);

                // Mensagem do CRUD
                Session["MsgCRUD"] = "A resposta do paciente " + pac.PACI_NM_NOME.ToUpper() + " em " + item.RECO_DT_DATA.Value.ToShortDateString() + " foi excluída com sucesso";
                Session["MensPaciente"] = 61;
        ...
        [HttpGet]
        public ActionResult ConfirmaPrevia(Int32 id)
        {
            try
            {
                // Verifica se tem usuario logado
                ...
                if ((USUARIO)Session["UserCredentials"] != null)
                {
                    ...
                    {
                        Session["MensPermissao"] = 2;
                        Session["ModuloPermissao"] = "Paciente - Resposta - Visualização";
                        return RedirectToAction("VoltarAnexoPaciente");
                    }
                }
                else
                ...
                LOG log = new LOG
                {
                    ...
                    ASSI_CD_ID = usuarioLogado.ASSI_CD_ID,
                    USUA_CD_ID = usuarioLogado.USUA_CD_ID,
                    LOG_NM_OPERACAO = "Paciente - Resposta - Visualização",
                    LOG_IN_ATIVO = 1,
                    LOG_TX_REGISTRO = json,
                    LOG_IN_SISTEMA = 6
                };
        ...
        public ActionResult VisualizarPrevia(Int32 id)
        {
            try
            {
                ...
                Int32 idAss = (Int32)Session["IdAssinante"];
                Session["ModuloAtual"] = "Paciente - Edição de Contato";

                // Prepara view
                List<SelectListItem> ver = new List<SelectListItem>();
                ...
                Session["VoltaTela"] = 1;
                RESPOSTA_CONSULTA item = baseApp.GetRespostaById(id);
                PacienteRespostaViewModel vm = Mapper.Map<RESPOSTA_CONSULTA, PacienteRespostaViewModel>(item);
                ...
                // Grava Acesso
                ControleAcessoMetodo grava = new ControleAcessoMetodo(aceApp);
                Int32 voltaX = grava.GravaAcesso(usuario.USUA_CD_ID, usuario.ASSI_CD_ID, "PACIENTE_RESPOSTA", "Paciente", "VisualizarPrevia");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult VisualizarPrevia(PacienteRespostaViewModel vm)
        {
            if ((String)Session["Ativa"] == null)
            {
                return RedirectToAction("Logout", "ControleAcesso");
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    hist.PAHI_IN_CHAVE = item.RECO_CD_ID;
                    hist.PAHI_NM_OPERACAO = "Paciente - Visualização de Resposta";
                    hist.PAHI_DS_DESCRICAO = "Paciente: " + pac.PACI_NM_NOME.ToUpper() + " - Resposta visualizada: " + item.RECO_DT_DATA.Value.ToShortDateString();
                    Int32 voltaHist = baseApp.ValidateCreateHistorico(hist);

                    // Mensagem do CRUD
                    Session["MsgCRUD"] = "A informação prévia gerada em " + item.RECO_DT_DATA.Value.ToShortDateString() + " do paciente " + pac.PACI_NM_NOME.ToUpper() + " foi visualizada com sucesso";
                    Session["MensPaciente"] = 61;
