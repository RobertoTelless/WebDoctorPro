...
{
    public class ChechTimeAttribute  : ValidationAttribute
    {
        public ChechTimeAttribute() { }
        ...
        public override bool IsValid(object value)
        {
            ...
            bool valido = UtilTime.CheckTime(value.ToString());
            return valido;
        }
    }
    ...
    public static class UtilTime
    {
        ...
        public static bool CheckTime(string time)
        {
            ...
            //Recupera minutos
            String minuto = timeLimpo.Substring(3, 2);
