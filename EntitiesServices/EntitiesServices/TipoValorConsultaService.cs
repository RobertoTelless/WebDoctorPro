...
{
    public class TipoValorConsultaService : ServiceBase<TIPO_VALOR_CONSULTA>, ITipoValorConsultaService
    {
        private readonly ITipoValorConsultaRepository _baseRepository;
        private readonly ILogRepository _logRepository;
        protected CRMSysDBEntities Db = new CRMSysDBEntities();

        public TipoValorConsultaService(ITipoValorConsultaRepository baseRepository, ILogRepository logRepository) : base(baseRepository)
        {
